...
class TvDetailFavorite : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.action_delete -> showAlertDialog(MovieDetailFavorite.ALERT_DIALOG_DELETE)
            android.R.id.home -> showAlertDialog(MovieDetailFavorite.ALERT_DIALOG_CLOSE)
        }
    ...
    private fun showAlertDialog(type: Int) {
        val isDialogClose = type == MovieDetailFavorite.ALERT_DIALOG_CLOSE
