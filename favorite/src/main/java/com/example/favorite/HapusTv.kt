...
class HapusTv : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (isEdit) {
            ...
            if (cursor != null) {
                tvshow = TvMappingHelper.mapCursorToObject(cursor)
                cursor.close()
            }
